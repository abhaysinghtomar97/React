05-css :
    ...
    I used css as a moduler styling by writing separate styling for each componets that prevent to repetetion in the same stylign in different components(like we have 2 different btns..)
